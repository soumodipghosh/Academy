...
const Banner = ({ image, title, subtitle, link, tag, reverse }) => {
  return (
    <div className="bg-[f9f9f9] pb-14">
      <div className="p-10">
        <div className="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 gap-12">
          ...
          >
            <motion.img
              ...
              src={image}
              alt=""
              className="w-[400px] h-full object-cover rounded-4xl"
            />
          </div>
          {/* Banner text section */}
          <div className="flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px]">
            <motion.p
              ...
              initial="hidden"
              whileInView={"visible"}
              className="text-sm text-orange-800 font-semibold capitalize"
            >
              {tag}
            </motion.p>
            <motion.p
            ...
            >
              <button className="bg-amber-700 font-semibold px-6 py-3 rounded-full hover:scale-110
                hover:shadow-xl duration-300 cursor-pointer !mt-5">Get Started</button>
            </motion.div>
          </div>
        </div>
      </div>
